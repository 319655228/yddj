 ...
 * 日期：2019-08-23 8:51
 */
public abstract class YddxObserver2<T> extends BaseObserver2<T> {
    private boolean mShowDialog;
    private YddxProgressDialog mDialog;
    private Context mContext;
    private Disposable d;

    protected YddxObserver2(Context mContext, boolean mShowDialog) {
        this.mShowDialog = mShowDialog;
        this.mContext = mContext;
    }

    protected YddxObserver2(Context ctx) {
        this(ctx, true);
    }
