...
public class PointDividerView extends View {
    ...
    private float dividerHeight; // 圆的间距
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension((int) mContext.getResources().getDimension(R.dimen.space_10),heightMeasureSpec);
    }
    ...
    protected void init(Context context, @Nullable AttributeSet attrs) {
        ...
        dividerHeight = mContext.getResources().getDimension(R.dimen.space_6);
    }
