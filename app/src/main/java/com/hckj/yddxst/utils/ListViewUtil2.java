...
public class ListViewUtil2 extends ListView implements AbsListView.OnScrollListener {
    ...
    public ListViewUtil2(Context context) {
        this(context, null);
    }

    public ListViewUtil2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ListViewUtil2(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        initHeaderView();
    ...
    private void initFooterView() {
        footerView = View.inflate(getContext(), R.layout.footer_view2, null);
