...
public class SxkListAdapter extends BaseAdapter {
    ...
    public SxkListAdapter(Context context, List<NewsInfo2> newsList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView != null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.item_news_sxk, parent, false);
