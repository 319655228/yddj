...
import com.hckj.yddxst.adapter.SxkListSecondAdapter;
...
public class SxkSecondActivity extends BaseActivity implements SxkListTask.SxkCallback {
    @BindView(R.id.sxk_list)
    ListViewUtil sxkList;
    private SxkListSecondAdapter sxcListAdapter;
    ...
    protected int getLayoutId() {
        return R.layout.activity_sxk_second;
    }
    ...
    protected void initData(Bundle savedInstanceState) {
        ...
        sxcListAdapter = new SxkListSecondAdapter(this, newsInfoList);
        ...
        list.add(3,id);
        list.add(4, null);
        new SxkListTask(SxkSecondActivity.this,this,false).execute(list);
        showDialog2("加载中");
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        if (sxcListAdapter.getCount() == total) {
                            ToastUtil.showShortToast(SxkSecondActivity.this, "没有更多了！");
                            ...
                            list.add(3,id);
                            list.add(4, null);
                            new SxkListTask(SxkSecondActivity.this,SxkSecondActivity.this,true).execute(list);
