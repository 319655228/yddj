...
public class SXKActivity extends BaseActivity implements SxkListTask.SxkCallback {
    ...
    EditText etSearch;
    private SxkListAdapter sxcListAdapter;
    ...
    protected void initData(Bundle savedInstanceState) {
        sxcListAdapter = new SxkListAdapter(this, newsInfoList);
        ...
        list.add(3, null);
        list.add(4,null);
        new SxkListTask(SXKActivity.this, this, false).execute(list);
        showDialog2("加载中");
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        if (sxcListAdapter.getCount() == total) {
                            ToastUtil.showShortToast(SXKActivity.this, "没有更多了！");
                            ...
                            list.add(3, null);
                            list.add(4, null);
                            new SxkListTask(SXKActivity.this, SXKActivity.this, true).execute(list);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_search:
                keyword = String.valueOf(etSearch.getText());
                List list = new ArrayList<>();
                list.add(0, String.valueOf(page++));
                list.add(1, "10");
                list.add(2, "sixiangku");
                ...
                list.add(4, keyword);
                showDialog2("加载中");
                new SxkListTask(SXKActivity.this, SXKActivity.this, false).execute(list);
                sxcListAdapter.notifyDataSetChanged();
                sxkList.finishLoadMore();
                break;
        }
