...
//    private final String DEF_URL = "http://www.xinhuanet.com/politics/xxjxs/";
    ...
    public static void startActivity(BaseActivity activity) {
        Intent intent = new Intent(activity, RLActivity.class);
        activity.startActivity(intent);
    }
    @Override
    protected void initData(Bundle savedInstanceState) {
        this.web_url = this.getIntent().getStringExtra("web_url");
        ...
        if (!TextUtils.isEmpty(web_url) && web_url.contains("rzkeji")) {
